...
/* tslint:disable */
/* eslint-disable */
import type { AgencyMessage } from '../models/AgencyMessage';
import type { WorkMessage } from '../models/WorkMessage';
...
export class WorksService {
     ...
     * @returns WorkMessage The work identified by {doi}.
     * @throws ApiError
     */
    public getWorks(
        doi: string,
    ): CancelablePromise<WorkMessage> {
        return this.httpRequest.request({
            ...
            errors: {
                404: `The work identified by {doi} does not exist.`,
            },
        });
    }
     ...
     * @param doi The DOI identifier associated with the work
     * @returns AgencyMessage The agency associated with work identified by {doi}.
     * @throws ApiError
     */
    public getWorksAgency(
        doi: string,
    ): CancelablePromise<AgencyMessage> {
        return this.httpRequest.request({
            method: 'GET',
