...
export class CoverageFull {
    ...
    static attributeTypeMap: Array<{name: string, baseName: string, type: string}> = [
        {
            "name": "affiliationsCurrent",
            "baseName": "affiliations-current",
            "type": "number"
        },
        {
            "name": "similarityCheckingCurrent",
            "baseName": "similarity-checking-current",
            "type": "number"
        },
        {
            "name": "descriptionsCurrent",
            "baseName": "descriptions-current",
            "type": "number"
        },
        {
            "name": "rorIdsCurrent",
            "baseName": "ror-ids-current",
            "type": "number"
        },
        {
            "name": "referencesBackfie",
            "baseName": "references-backfie",
            "type": "number"
        },
        {
            "name": "fundersBackfile",
            "baseName": "funders-backfile",
            "type": "number"
        },
        {
            "name": "licensesBackfile",
            "baseName": "licenses-backfile",
            "type": "number"
        },
        {
            "name": "fundersCurrent",
            "baseName": "funders-current",
            "type": "number"
        },
        {
            "name": "affiliationsBackfile",
            "baseName": "affiliations-backfile",
            "type": "number"
        },
        {
            "name": "resourceLinksBackfile",
            "baseName": "resource-links-backfile",
            "type": "number"
        },
        {
            "name": "orcidsBackfile",
            "baseName": "orcids-backfile",
            "type": "number"
        },
        {
            "name": "updatePoliciesCurrent",
            "baseName": "update-policies-current",
            "type": "number"
        },
        {
            "name": "rorIdsBackfile",
            "baseName": "ror-ids-backfile",
            "type": "number"
        },
        {
            "name": "orcidsCurrent",
            "baseName": "orcids-current",
            "type": "number"
        },
        {
            "name": "similarityCheckingBackfile",
            "baseName": "similarity-checking-backfile",
            "type": "number"
        },
        {
            "name": "descriptionsBackfile",
            "baseName": "descriptions-backfile",
            "type": "number"
        },
        {
            "name": "awardNumbersBackfile",
            "baseName": "award-numbers-backfile",
            "type": "number"
        },
        {
            "name": "updatePoliciesBackfile",
            "baseName": "update-policies-backfile",
            "type": "number"
        },
        {
            "name": "licensesCurrent",
            "baseName": "licenses-current",
            "type": "number"
        },
        {
            "name": "awardNumbersCurrent",
            "baseName": "award-numbers-current",
            "type": "number"
        },
        {
            "name": "abstractsBackfile",
            "baseName": "abstracts-backfile",
            "type": "number"
        },
        {
            "name": "resourceLinksCurrent",
            "baseName": "resource-links-current",
            "type": "number"
        },
        {
            "name": "abstractsCurrent",
            "baseName": "abstracts-current",
            "type": "number"
        },
        {
            "name": "referencesCurrent",
            "baseName": "references-current",
            "type": "number"
        }    ];

    static getAttributeTypeMap() {
        return CoverageFull.attributeTypeMap;
    }
}
