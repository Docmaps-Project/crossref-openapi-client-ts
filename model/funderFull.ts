...
export class FunderFull {
    'hierarchyNames': { [key: string]: string | undefined; };
    ...
    */
    ...
    static attributeTypeMap: Array<{name: string, baseName: string, type: string}> = [
        {
            "name": "hierarchyNames",
            "baseName": "hierarchy-names",
            "type": "{ [key: string]: string | undefined; }"
        },
        {
            "name": "replacedBy",
            "baseName": "replaced-by",
            "type": "Array<string>"
        },
        {
            "name": "workCount",
        ...
        {
            "name": "descendantWorkCount",
            "baseName": "descendant-work-count",
            "type": "number"
        },
        {
            "name": "id",
    ...
    static getAttributeTypeMap() {
        return FunderFull.attributeTypeMap;
    }
}
