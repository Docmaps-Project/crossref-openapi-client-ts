...
/* tslint:disable */
/* eslint-disable */
import type { TypeMessage } from '../models/TypeMessage';
import type { TypesMessage } from '../models/TypesMessage';
...
export class TypesService {
     ...
     * @param id
     * @returns TypeMessage The type identified by {id}.
     * @throws ApiError
     */
    public getTypes(
        id: number,
    ): CancelablePromise<TypeMessage> {
        return this.httpRequest.request({
            ...
            errors: {
                404: `The type identified by {id} does not exist.`,
            },
        });
    }
     ...
     * @returns TypesMessage A collection of types
     * @throws ApiError
     */
    public getTypes1(
        rows?: number,
        mailto?: string,
        offset?: number,
    ): CancelablePromise<TypesMessage> {
        return this.httpRequest.request({
            method: 'GET',
            url: '/types',
            query: {
