...
/* tslint:disable */
/* eslint-disable */
import type { MemberMessage } from '../models/MemberMessage';
import type { MembersMessage } from '../models/MembersMessage';
...
export class MembersService {
    ...
    public getMembers({
        ...
        return this.httpRequest.request({
            ...
            errors: {
                404: `The prefix data identified by {id} does not exist.`,
            },
        });
    }
