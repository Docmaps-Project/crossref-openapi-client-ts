...
export class Member {
    ...
    'id': number;
    'tokens': Array<string>;
    'countsType': MembersMessageMessageItemsCountsType;
    'coverageType': MembersMessageMessageItemsCoverageType;
    'flags': Flags;
    'location': string;
    'names': Array<string>;
    ...
    static attributeTypeMap: Array<{name: string, baseName: string, type: string}> = [
        {
            ...
            "baseName": "last-status-check-time",
            "type": "number"
        },
        {
            "name": "primaryName",
        ...
        },
        {
            "name": "breakdowns",
            "baseName": "breakdowns",
            "type": "MembersMessageMessageItemsBreakdowns"
        },
        {
            "name": "prefixes",
            "baseName": "prefixes",
        ...
        {
            "name": "countsType",
            "baseName": "counts-type",
            "type": "MembersMessageMessageItemsCountsType"
        },
        {
            "name": "coverageType",
            "baseName": "coverage-type",
            "type": "MembersMessageMessageItemsCoverageType"
        },
        {
            "name": "flags",
            "baseName": "flags",
