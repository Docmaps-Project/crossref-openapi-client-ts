...
export class Coverage {
    ...
    static attributeTypeMap: Array<{name: string, baseName: string, type: string}> = [
        ...
        {
            "name": "similarityChecking",
            "baseName": "similarity-checking",
            "type": "number"
        },
        {
            "name": "awardNumbers",
            "baseName": "award-numbers",
            "type": "number"
        },
        {
            "name": "rorIds",
        ...
        {
            "name": "updatePolicies",
            "baseName": "update-policies",
            "type": "number"
        },
        {
            "name": "resourceLinks",
            "baseName": "resource-links",
            "type": "number"
        },
        {
            "name": "descriptions",
    ...
    static getAttributeTypeMap() {
        return Coverage.attributeTypeMap;
    }
}
