...
/* tslint:disable */
/* eslint-disable */
import type { JournalMessage } from '../models/JournalMessage';
import type { JournalsMessage } from '../models/JournalsMessage';
...
export class JournalsService {
     ...
     * @returns JournalsMessage A list of journals
     * @throws ApiError
     */
    public getJournals(
        cursor?: string,
        ...
        mailto?: string,
        offset?: number,
    ): CancelablePromise<JournalsMessage> {
     ...
     * @returns JournalMessage The journal identified by {issn}.
     * @throws ApiError
     */
    public getJournals1(
        issn: string,
    ): CancelablePromise<JournalMessage> {
        return this.httpRequest.request({
            method: 'GET',
            url: '/journals/{issn}',
            path: {
            ...
            errors: {
                404: `The journal identified by {issn} does not exist.`,
            },
        });
    }
